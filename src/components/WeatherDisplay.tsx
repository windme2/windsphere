        ...
        <div className="flex items-start gap-3 md:gap-6">
          <div className="flex-1">
            ...
            <p className="text-xs md:text-base text-gray-600">
              อัพเดทล่าสุด: {formatTime(weather.timestamp)}
            </p>
          </div>
        ...
        <div className="mt-4 md:mt-6 flex flex-wrap justify-between items-center gap-3 md:gap-6">
          <div>
            ...
            <div className="text-sm md:text-base text-gray-600">
              รู้สึกเหมือน {Math.round(weather.feelsLike)}°C
            </div>
          </div>
          ...
          <div className="flex gap-4 md:gap-6">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-xs md:text-base text-gray-600">ความชื้น</div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-xs md:text-base text-gray-600">ลม</div>
